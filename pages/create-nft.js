...
const CreateNFT = () => {
  ...
  const fileStyle = useMemo(() => (
    `dark:bg-nft-black-1 bg-white border dark:border-white border-nft-gray-2 rounded-3xl flex flex-col items-center p-5 rounded-sm border-dashed
            ...
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center ">
                ...
                <div className="my-12 w-full flex justify-center ">
                  <Image src={images.upload} width={100} height={100} objectFit="contain" className={theme === 'light' && 'filter invert'} />
                </div>
